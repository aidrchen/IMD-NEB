...
#ifdef NEB
    fprintf(fl, "checkangle checkangle2 leftspring rightspring ");
#endif
...
#ifdef NEB
  fprintf(eng_file, format, checkangle );
  fprintf(eng_file, format, checkangle2 );
  fprintf(eng_file, format, norm1);
  fprintf(eng_file, format, norm2);
#endif
